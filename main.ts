...
namespace HuLuMaoGame1 {
    ...
    export let asc16=[
        ...
        [0x00,0x00,0x00,0x00,0xE0,0x00,0x00,0x00,0x00,0x01,0x01,0x01,0x0F,0x01,0x01,0x01],/*"+",0*/
        /* (8 X 16 , 宋体 )*/
        
        [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x01,0x01,0x01,0x01,0x01,0x00],/*"-",1*/
        /* (8 X 16 , 宋体 )*/
        
        [0x08,0x18,0x68,0x80,0x80,0x68,0x18,0x08,0x20,0x30,0x2C,0x03,0x03,0x2C,0x30,0x20],/*"X",2*/
        /* (8 X 16 , 宋体 )*/
        
        [0x00,0x00,0x00,0x00,0xC0,0x38,0x04,0x00,0x00,0x60,0x18,0x07,0x00,0x00,0x00,0x00],/*"/",3*/
        /* (8 X 16 , 宋体 )*/
        
        [0x00,0x40,0x40,0x40,0x40,0x40,0x40,0x00,0x00,0x02,0x02,0x02,0x02,0x02,0x02,0x00],/*"=",4*/
        /* (8 X 16 , 宋体 )*/
        
        [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x30,0x00,0x00,0x00,0x00,0x00],/*".",5*/
        /* (8 X 16 , 宋体 )*/
        
        [0x00,0x00,0x00,0xC0,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x30,0x00,0x00,0x00],/*":",6*/
        /* (8 X 16 , 宋体 )*/
    ...
    */
    ...
    //% color="#cc33ff"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=10
    export function OLED_ShowChar(x:number,y:number,chr:char){
        let t
        OLED_Set_Pos(x,y);
        for(t=0;t<16;t++)
		{
		    OLED_WR_Byte(asc16[chr][t],OLED_DATA);
        }	
    }
