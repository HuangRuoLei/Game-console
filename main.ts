...
namespace HuLuMaoGame1 {
    ...
    export let asc16=[
        ...
        0x0000225C,0x94A84810,0x10242A52,0x54880000 ,//"%"   37       0
        ...
        0x00000000,0x10543810,0x38541000,0x00000000 ,//"*"   42       1
        ...
        0x00000000,0xC0300C02,0x0C30C000,0x00000000 ,//">"  62      21
        //0x00384482,0x82020408,0x10101000,0x10100000 ,//"?"
        //0x00003844,0x829AAAAA,0xAAAAAA96,0x80423C00 ,//"@"
        0x00001010,0x10282828,0x44447C44,0x44EE0000 ,//"A"  65      22
        ...
        0x00007E44,0x84080810,0x20204082,0x84FC0000 ,//"Z"  90     47
        ...
        0x00304884,0x00000000,0x00000000,0x00000000 ,//"^"  94     48
    ...
    */
    ...
    export function OLED_ShowChar(x:number,y:number,chr:string){
        ...
        for(n=0;n<chr.length;n++){
            ...
            // else k=0
            if(k==37) k=0
            else if((k>41)&&(k<63)) k-=41
            else if((k>64)&&(k<91)) k-=43
            else if(k==94) k=48
