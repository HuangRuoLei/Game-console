    ...
    */
    ...
    export function OLED_ShowChar(x:number,y:number,chr:string){
        ...
        for(n=0;n<chr.length;n++){
            ...
            data=0;
            for(i=0;i<8;i++){
                data|=(((asc16[0][k]>>24)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[0][k]>>16)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[0][k]>>8)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[0][k])&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[1][k]>>24)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[1][k]>>16)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[1][k]>>8)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[1][k])&0x000000ff)<<i)&0x80;
                OLED_WR_Byte(data,OLED_DATA);
				data=0;
            }
            OLED_Set_Pos(x,y+1);
            for(i=0;i<8;i++){
                data|=(((asc16[2][k]>>24)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[2][k]>>16)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[2][k]>>8)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[2][k])&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[3][k]>>24)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[3][k]>>16)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[3][k]>>8)&0x000000ff)<<i)&0x80;data>>=1
                data|=(((asc16[3][k])&0x000000ff)<<i)&0x80;
                OLED_WR_Byte(data,OLED_DATA);
				data=0;
            }
            x+=8;
